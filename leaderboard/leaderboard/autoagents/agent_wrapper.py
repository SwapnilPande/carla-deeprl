...
# MODIFIFED TO ADD LANE INVASION
SENSORS_LIMITS = {
    'sensor.camera.rgb': 6,
...
class AgentWrapper(object):
    ...
    allowed_sensors = [
        ...
        'sensor.lane_invasion',                         # MODIFIED: This is specific to us
    ...
    def setup_sensors(self, vehicle, debug_mode=False):
        ...
        for sensor_spec in self._agent.sensors():
            ...
            elif sensor_spec['type'].startswith('sensor.lane_invasion'):
                delta_time = CarlaDataProvider.get_world().get_settings().fixed_delta_seconds
                frame_rate = 1 / delta_time
                sensor = LaneInvasionReader(bp_library, vehicle, frame_rate)
