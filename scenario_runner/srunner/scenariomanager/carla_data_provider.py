...
class CarlaDataProvider(object):  # pylint: disable=too-many-public-methods
    ...
    @staticmethod
    def set_ego_vehicle(vehicle):
        CarlaDataProvider._vehicle = vehicle

    @staticmethod
    def get_ego_vehicle():
        return CarlaDataProvider._vehicle
    ...
    @staticmethod
    def set_ego_vehicle_coarse_route(route):
        CarlaDataProvider._ego_vehicle_coarse_route = route

    @staticmethod
    def get_ego_vehicle_coarse_route():
        return CarlaDataProvider._ego_vehicle_coarse_route
    ...
    # MODIFIED
    @staticmethod
    def set_lane_invasion(lane_invastion_data):
        """
        Set whether or not the lane invasion has happened, based on the scenario tree
        """
        CarlaDataProvider._lane_invasion = lane_invastion_data

    @staticmethod
    def get_lane_invasion(lane_invastion_data):
        """
        Get whether or not the lane invasion has happened, based on the scenario tree
        """
        return CarlaDataProvider._lane_invasion
