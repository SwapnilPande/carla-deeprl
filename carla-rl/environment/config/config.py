...
from environment.config import observation_configs, action_configs, scenario_configs, reward_configs
...
class DefaultMainConfig(BaseMainConfig):
    ...
    def __init__(self):
        super().__init__()
        #### Server Setup ####
        self.server_path = CARLA_9_4_PATH
        self.server_binary = CARLA_9_4_PATH + '/CarlaUE4.sh'
        self.server_fps = 10
        self.server_port = -1
