...
#     logger_conf.populate(experiment_name = args.exp_name, tags = ["Online_PPO_Leaderboard"])
...
#     env = CarlaEnv(config = config, logger = logger, log_dir = logger.log_dir)
...
def main(args):
    ...
    print('<<<<<<Max Speed>>>>>>', config.action_config.target_speed)
